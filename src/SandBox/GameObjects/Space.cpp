...
SpaceArea::SpaceArea(float aspectRatio, float rocketX, float rocketY)
{
	...
	AnimationSpeed = 0.015f;

	

	m_RightAnimationTextures.push_back(Engine::Texture2D::Create("assets/images/anim/test/right/adventurer-run-00.png"));
	m_RightAnimationTextures.push_back(Engine::Texture2D::Create("assets/images/anim/test/right/adventurer-run-01.png"));
	m_RightAnimationTextures.push_back(Engine::Texture2D::Create("assets/images/anim/test/right/adventurer-run-02.png"));
	m_RightAnimationTextures.push_back(Engine::Texture2D::Create("assets/images/anim/test/right/adventurer-run-03.png"));
	m_RightAnimationTextures.push_back(Engine::Texture2D::Create("assets/images/anim/test/right/adventurer-run-04.png"));
	m_RightAnimationTextures.push_back(Engine::Texture2D::Create("assets/images/anim/test/right/adventurer-run-05.png"));
...
void SpaceArea::Update(float DeltaTime)
{
	...
	m_Camera->SetPosition({ m_RocketCharacter->GetSprite()->GetPosition().x,m_RocketCharacter->GetSprite()->GetPosition().y,0 });

	m_RocketCharacter->GetSprite()->SetSize({ 2.2,2 });
